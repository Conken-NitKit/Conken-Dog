...
export const MONEY: ISection = {
  ...
  contentsList: [
    ...
    {
      title: "日本人というリスク",
      link: "https://youtu.be/NmFW41IrqnE",
      mediaType: ["READ_ONLY", "VIDEO"],
      requiredTime: 37,
    },
    {
    ...
    {
      title: "世界のお金持ちが実践する資産形成術",
      link: "https://youtu.be/VKA31naRrPw",
      mediaType: ["READ_ONLY", "VIDEO"],
      requiredTime: 30,
    },
    {
      title: "リスクを冒さずお金持ちになる方法",
